...
if __name__ == '__main__':
    ...
    data_gen(all_sents[15000:], data_len=100000, file_name='train.txt')
    data_gen(all_sents[2000:15000], data_len=10000, file_name='valid.txt')
    ...
    # data_gen(all_sents[:2000], data_len=100, file_name='test_no_punct.txt', remove_punctuation=1)
    # #For generating partial punctuation removed data, might be wrong cased
    # data_gen(all_sents[:2000], data_len=100, file_name='test_partial_punct.txt', remove_punctuation=2)
